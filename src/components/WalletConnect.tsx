...
const WalletConnect = () => {
  // Wrap the component with a try-catch block to gracefully handle any context issues
  try {
    ...
    console.error("Error rendering WalletConnect:", error);
    
    // Fallback UI if there's an issue with the WalletProvider
    return (
      <Button
        variant="outline"
        disabled
